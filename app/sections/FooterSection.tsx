    ...
    <footer className="border-t border-white/5 pb-10">
      <div className="mx-auto flex max-w-6xl flex-col gap-4 px-6 pt-8">
        <div className="flex items-center justify-between">
          ...
          <a
            href="https://www.producthunt.com/products/safe-4/reviews/new?utm_source=badge-product_review&utm_medium=badge&utm_source=badge-safe&#0045;4"
            target="_blank"
          >
            <img
              src="https://api.producthunt.com/widgets/embed-image/v1/product_review.svg?product_id=1244328&theme=light"
