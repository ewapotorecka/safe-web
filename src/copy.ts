export const COPY = {
  en: {
    ...
    features: {
      ...
      subtitle:
        'Designed so updates are fast, clear, and respectful of privacy.',
      cards: [
        {
  ...
  ua: {
    ...
    features: {
      ...
      cards: [
        ...
        {
          title: 'Коло довіри',
          text: 'Запрошуйте близьких і переглядайте стрічку статусів друзів.',
        },
        {
          title: 'Сповіщення',
    ...
    how: {
      ...
      steps: [
        ...
        },
        {
          ...
          text: 'Надсилайте push-сповіщення та пінгуйте друзів, якщо хтось довго не оновлюється.',
        },
      ],
    },
    ukraine: {
